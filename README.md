...
- 🔭 I’m currently working on [Python Data Analysis and Visualization] analyze,visualize and present data. Includes diverse coding samples in jupyter notebooks (Numpy, Pandas, SQL, Machine Learning, Web Scraping, Visualization, and Statistics).
- Learning to use in Anaconda Navigator and in Visual Studio Code
